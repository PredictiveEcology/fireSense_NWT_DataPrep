...
climatNA_outputs <- read.csv.ffdf(
  file = "C:/climateNA_inputs_1995-2015AMT.csv", 
  header = TRUE, 
  colClasses = c("integer", "integer", "factor", rep("numeric", 171))
)

climatNA_outputs <- read_csv("C:/climateNA_inputs_1995-2015AMT.csv") %>%
  select( Year, ID1, Latitude, Longitude, num_range("Tmax", 4:9, 2), num_range("PPT",  4:9, 2) ) 
