...
setPaths(
  cachePath = file.path("~/project", Sys.getenv("USER"), "cache"),
  inputPath = file.path("~/project", Sys.getenv("USER"), "inputs"),
  modulePath = file.path("~/project", Sys.getenv("USER"))
)
...
times <- list(start = 1995, end = 2015)
