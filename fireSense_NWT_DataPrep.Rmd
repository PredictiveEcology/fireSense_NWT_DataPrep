...
modules <- list("waterlandClassification", "fireSense_NWT_DataPrep")

parameters <- list(
  waterlandClassification = list(baseLayer = "LCC05"),
  fireSense_NWT_DataPrep = list(res = 10000)
)

cloudFolderID <- "https://drive.google.com/open?id=1PoEkOkg_ixnAdDqqTQcun77nUvkEHDc0"

# MDC_BCR6_NWT_250m <- raster::raster(nrow = 10, ncol = 10, res = 250, vals = 1)
