...
### Produce and save MDC rasters for the 2000-2010 period, BCR6 and BCR6 as contained in the NWT, 250m resolution
``` {R}
    ...
    lapply(
      ...
      function(month)
      {
        BCR6[MDC[MDC[["Year"]] == year, "ID1"][]] <-
               MDC[MDC[["Year"]] == year, paste0("MDC0", month)][]
        print(
          writeRaster(
            BCR6, 
        ...
        Cache(
          ...
          maskWithRTM = TRUE,
          filename2 = paste0("MDC0", month, "_", year, "_BCR6_NWT_", res, ".tif"),
          datatype = "FLT4S",
          method = "bilinear",
          overwrite = TRUE
        )
